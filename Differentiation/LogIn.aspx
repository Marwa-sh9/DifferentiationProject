...
<%--    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">--%>
    ...
    <link href="Design/LogIn/StyleSheet1.css" rel="stylesheet"/>
...
<%--            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="pass" ErrorMessage=" password is Required" ForeColor="Red"></asp:RequiredFieldValidator>--%>
        ...
        <asp:Button  ID="login" runat="server"
            class="btn btn-primary btn-outline-info btn-lg col-lg-10 btn-block"
            Text="Log In" OnClick="Login_click" Width="310px" Height="50px" />
        <br />
    </form>
